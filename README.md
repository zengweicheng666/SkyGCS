...
│  │  ├─ mavlink_generated.h          #   由官方 c_library_v2 生成的消息表（24 条）
│  │  ├─ mavlink_messages.h           #   常用消息结构体 + 便捷 pack/unpack
│  │  └─ mavlink_names.h              #   指令/结果名称（UI 层）
│  ├─ core/vehicle.h/.cpp             # VehicleState 状态聚合（信号驱动 UI）
...
└─ tests/                             # test_codec / test_integration / shot_main
```
